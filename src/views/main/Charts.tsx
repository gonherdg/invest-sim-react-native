...
const DATA = [
  {
    ...
    price: '$423.48',
    variation: '+3.38%',
    imgSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqj34cOFqUbqCNwhVYMn5O2BbUD8Mq8NXmDAxfCDSifeGmiXKjdapKPm8SCo6mmgbjj9g&usqp=CAU',
  },
  {
...
const Item = ({ title, subtitle, imgSrc, price, variation }) => (
  <View style={S.item}>
    ...
    <Image
      ...
      source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNmoLz5weQDnEqFVP70jaG3wDf-1MkmK0yrA&usqp=CAU'}}
    />
